! function(t, e) {
    ...
    199: function(t, e, s) {
        "use strict";
        s.r(e), s.d(e, "TemplateCustomizer", (function() {
            return v
        }));
        s(200);
        var i = s(190),
                    ...
                    value: function() {
                        ...
                        if (this._hasControls("layoutType layoutNavbarFixed layoutFooterFixed layoutMenuFlipped showDropdownOnHover", !0)) {
                            ...
                            if (this._hasControls("layoutType")) {
                                this._controls.layoutType = v.querySelector(".template-customizer-layouts-options"), this._controls.layoutType.querySelector('input[value="'.concat(this.settings.layoutType, '"]')).setAttribute("checked", "checked");
                                var b = function(e) {
    ...
    6: function(t, e, s) {
        ...
        function f(t, e) {
            ...
            } else s = c(e), i = p.bind(null, s, e), o = function() {
                ! function(t) {
